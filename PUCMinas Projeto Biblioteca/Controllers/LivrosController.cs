...
namespace PUCMinas_Projeto_Biblioteca.Controllers
{
    public class LivrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,Autor,ISBN")] Livros livros)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,Autor,ISBN")] Livros livros)
        {
            if (id != livros.Id)
            {
                return NotFound();
